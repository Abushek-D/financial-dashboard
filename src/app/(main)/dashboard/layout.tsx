    ...
    <SidebarProvider defaultOpen={defaultOpen}>
      ...
      <SidebarInset>
        ...
        >
          ...
          {/*<div className="flex w-full items-center justify-between p-2 bg-sidebar rounded-lg border border-sidebar-border shadow-sm md:peer-data-[variant=floating]:rounded-lg">*/}
